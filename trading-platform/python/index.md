...
* `host` (str): base URL of your Tradeboard server. REST calls go to `{host}/api/{version}/`.
...
GTT orders and the strategy module methods need **tradeboard 2.0.4 or newer**.
Upgrade with `pip install -U tradeboard`.
...
Tradeboard's `/strategy` module runs multi-leg options strategies with end-to-end risk
