...
The API Playground is a web-based interface for testing Tradeboard REST API endpoints. It provides an intuitive UI to explore, test, and debug all available API endpoints without needing external tools like Postman.
...
* **Comprehensive Endpoint Library**: Pre-configured with all Tradeboard API endpoints loaded from Bruno collection
...
* Postman Collection (`collections/postman/tradeboard.postman_collection.json`)
* Bruno Collection (`collections/tradeboard/*.bru`)
...
* Make sure you're logged into Tradeboard
...
* Check if the Tradeboard server is running
