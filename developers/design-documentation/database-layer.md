...
Tradeboard generates one current 64-character hexadecimal API key per user. `database/auth_db.py` stores:
...
|---|---|
| `tradeboard.db` | Users, hashes, encrypted tokens/API key copy, settings, sessions, OAuth and application state |
