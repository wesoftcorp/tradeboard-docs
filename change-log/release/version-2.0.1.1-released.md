...
* Available at [https://pypi.org/project/tradeboard/1.0.50/](https://pypi.org/project/tradeboard/1.0.50/)
...
* `tradeboard` SDK pin: `1.0.49` → `1.0.50` (PyPI: [https://pypi.org/project/tradeboard/1.0.50/](https://pypi.org/project/tradeboard/1.0.50/))
...
* **Python SDK on PyPI**: [https://pypi.org/project/tradeboard/1.0.50/](https://pypi.org/project/tradeboard/1.0.50/)
* **WhatsApp service docs**: [https://docs.algo.wesoftcorp.com/api-documentation/v1/whatsapp-services](https://docs.algo.wesoftcorp.com/api-documentation/v1/whatsapp-services)
