...
* **Shared branding with tradeboard-charts 2.1.9 (`718d10bfa`)** and **2.1.8 (`80b24d7f8`)** - the terminal's watermark and chrome come from the engine, removing the local copy.
...
* `tradeboard-charts`: **2.1.7** to **2.2.0** (`80b24d7f8`, `718d10bfa`, `50f94b717`)
* The pinned `tradeboard` SDK: unchanged at **2.0.5**
