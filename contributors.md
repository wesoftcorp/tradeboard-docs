...
* **API documentation**: [Tradeboard API v1](api-documentation/v1/README.md)
...
# Add upstream remote
git remote add upstream https://github.com/wesoftcorp/tradeboard-docs.git
...
2. **Bug Fixes**
   * Check [issues labeled "good first issue"](https://github.com/wesoftcorp/tradeboard-docs/labels/good%20first%20issue)
...
* **GitHub Discussions**: Ask questions in [GitHub Discussions](https://github.com/wesoftcorp/tradeboard-docs/discussions)
* **Documentation**: Check [docs.algo.wesoftcorp.com](https://docs.algo.wesoftcorp.com)
* **GitHub Issues**: Report bugs in [Issues](https://github.com/wesoftcorp/tradeboard-docs/issues)

#### Before Asking for Help

1. **Search existing issues**: your question might already be answered
2. **Check documentation**: review docs at docs.algo.wesoftcorp.com
...
Tradeboard is released under the **AGPL v3.0 License**. See the LICENSE file for details.
