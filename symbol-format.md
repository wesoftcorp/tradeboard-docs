...
The supported exchange symbol formats in Tradeboard allow for an identification system that denotes where the instrument is traded, along with specific details that vary by instrument type:<br>
